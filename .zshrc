...
# VI MODE: HOME, END, DELETE
for keymap in viins vicmd; do
  bindkey -M $keymap "\e[1~" vi-beginning-of-line
  bindkey -M $keymap "\e[4~" vi-end-of-line
  bindkey -M $keymap "\e[3~" delete-char
  bindkey -M $keymap "${terminfo[khome]}" vi-beginning-of-line
  bindkey -M $keymap "${terminfo[kend]}" vi-end-of-line
  bindkey -M $keymap "\eOH" vi-beginning-of-line
  bindkey -M $keymap "\eOF" vi-end-of-line
  bindkey -M $keymap "\e[H" vi-beginning-of-line
  bindkey -M $keymap "\e[F" vi-end-of-line
done

# VI MODE: INSERT (Toggle between insert and command mode)
bindkey -M viins "\e[2~" vi-cmd-mode
