-- Plugin overrides are kept minimal: non-default values are active; upstream defaults remain commented for reference.
...
-- Hyprgrass: all settings below match upstream defaults and are intentionally disabled.
-- Uncomment the block and only the values you want to override.
