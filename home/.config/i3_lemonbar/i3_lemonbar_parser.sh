...
while read -r line; do
  ...
  case $line in
    ...
    WIN*)
      # window title
      title="%{F${color_ina} B${color_transp}}${sep_right}%{F${color_title} T4} ${line#???}%{T-}"
      ;;
