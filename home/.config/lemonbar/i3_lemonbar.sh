...
done < <(echo && stdbuf -oL inotifywait -m -e modify /sys/class/backlight/intel_backlight/actual_brightness & stdbuf -oL inotifywait -m -e modify /sys/class/backlight/acpi_video0/actual_brightness & upower --monitor) &
